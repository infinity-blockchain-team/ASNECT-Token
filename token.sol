...
contract ASNECT is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 100000 * 10**decimals();

    uint256 public maxTxAmount = 10000 * 10**decimals(); 
    ...
    function changeBuyFees(uint256 marketingFee, uint256 devFee)
        public
        onlyOwner
    {
    ...
    function changeSellFees(uint256 marketingFee, uint256 devFee)
        public
        onlyOwner
    {
        require(marketingFee.add(devFee) <= 250, "Tax too high");
